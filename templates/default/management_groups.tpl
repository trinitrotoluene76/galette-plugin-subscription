	...
	<div class="bigtable wrmenu">
		...
		{/if}	
			...
			<div class="button-container">
				<a id="btnadd" class="button" href="{$galette_base_path}{$subscription_dir}send_files_standalone.php?id_act={$activity->id_group}&vierge=1" target="_blank">{_T string="Add/view files or forms for the group"}</a>
