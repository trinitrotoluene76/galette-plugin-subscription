{if $login->isGroupManager() == 1 && $login->isSuperAdmin() != 1}
	...
	<ul>
		<li {if $PAGENAME eq "about_group.php"} class="selected"{/if}><a href="{$galette_base_path}{$galette_galette_subscription_path}about_group.php" title="{_T string="Informations about groups"}">{_T string="About groups"}</a></li>
