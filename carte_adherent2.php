...
if(isset($_GET[code]))
	{
	//réception des données et décodage (GET)
	$uncompressed = gzinflate(urldecode($_GET[code]));
	$variables = explode(";", $uncompressed);
	$date_fin_validite = DateTime::createFromFormat('Y-m-d', $variables[1]);
	$today= new DateTime("now");
	
	//si la date de fin de validité n'est pas atteinte, on génère la carte
	if($today<$date_fin_validite)
		{
		$unique =$variables[0];//id_adh
		/*
